        ...
        <div class="modal-body">
          <form role="form" method="post" action="cat_transac.php?action=add">
            ...
            <div class="form-group">
              ...
              <input class="form-control" placeholder="Description" name="descrip">
            </div>
            <hr>
  ...
  <div class="modal fade" id="brandModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="brand_transac.php?action=add">
            <div class="form-group">
              <label>Brand Name:</label>
              <input class="form-control" placeholder="Brand Name" name="brand" required>
            </div>
            <div class="form-group">
              <label>Description:</label>
              <input class="form-control" placeholder="Description" name="descrip">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="cust_transac.php?action=add">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="number" placeholder="Phone Number" name="phonenumber" required>
            </div>
            <div class="form-group">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="emp_transac.php?action=add">          
              ...
              <div class="form-group">
                <label>Current Address:</label>
                <input class="form-control" placeholder="Barangay and/or house block number" name="address">
              </div>
              <div class="form-group">
