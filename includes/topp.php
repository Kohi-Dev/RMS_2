  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  style="text-decoration: none; font-size: 18px; font-weight: bold;" href="index.php">
        ...
        <div class="sidebar-brand-text mx-2">Repairs and Inventory</div>
      </a>

          <!-- Topbar Navbar -->
          <ul class="navbar-nav ml-auto">
            <li  class="nav-item dropdown no-arrow">
               <a class="nav-link" href="rep.php" role="button">
                <span class="mr-1 d-none d-lg-inline text-gray-600 small">REP</span>
              </a>

            </li>
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="pos.php" role="button">
                <span class="mr-1 d-none d-lg-inline text-gray-600 small">POS</span>
              </a>
            </li>
